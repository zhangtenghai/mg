...
/*-------------------------------------------------------------------------*/	
	//nav 
   $('.nav').delegate('li','mouseenter',function(e){ 
   	   $(this).siblings().find(".nav-dropbox").hide();
	   $(this).children(".nav-dropbox").fadeIn("slow");
   }).delegate('li','mouseleave',function(e){ 
	   $(this).children(".nav-dropbox").hide();
   }).delegate('.nav-dropbox','mouseenter',function(e){
       $(this).show();
   }).delegate('.nav-dropbox','mouseleave',function(e){       
       $(this).hide();
   ...
   $('.user-info').delegate('div','mouseenter',function(e){    
       ...
       $(this).siblings(".user-dropbox").hide();
   }).delegate('.user-dropbox','mouseenter',function(e){ 
       $(this).stop(true,true).show();
   }).delegate('.user-dropbox','mouseleave',function(e){       
       $(this).hide();
