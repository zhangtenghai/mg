...
var Layout = function () {
  ...
  var layoutImgPath = Metronic.getAssetsPath() + 'images/';

  var layoutCssPath = Metronic.getAssetsPath() + 'stylesheets/';
  ...
  return {
    ...
    init: function () {
      ...
      Metronic.addResizeHandler(handleStickyActionButtons); // reinitialize button height
    },
